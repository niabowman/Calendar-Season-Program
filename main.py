...
if month == "December" and day >= 21 and day <= 31:
    print("Winter")
elif month == "January" and day >= 1 and day <= 31:
    print("Winter")
elif month == "February" and day >= 1 and day <= 28:
    print("Winter")
elif month == "March" and day >= 1 and day <= 19:
    print("Winter")
elif month == "March" and day >= 20 and day <= 31:
    print("Spring")
    ...
    print("Spring")
elif month == "June" and day >= 21 and day <= 31:
    print("Summer")
